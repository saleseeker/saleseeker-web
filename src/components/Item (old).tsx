...
import { IItem, ISite, ISiteItem } from '../Interfaces';
import minBy from 'lodash.minby';
import {formatCurrency} from '../common/Formatter'

type ItemProps = {
  item: IItem,
  sites: { [id: number]: ISite }
}

function renderPrice(item: IItem, sites: { [id: number]: ISite }, minSiteItem: ISiteItem) {
...
const Item: React.FC<ItemProps> = ({ item, sites }: ItemProps) => {
